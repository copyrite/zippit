...
%ZIPPIT.GEODESIC Set up conformal map as given by geodesic algorithm
%   Performs geodesic algorithm on polygon vertices to determine the parameters
%   zn, and sets up the corresponding forward and inverse for direct access.

    % Set up component functions
    phi_fwd_1 = @phi_geod_fwd_1;
    phi_fwd_i = @phi_geod_fwd_i;
    phi_fwd_np1 = @phi_geod_fwd_np1;

    phi_inv_1 = @phi_geod_inv_1;
    phi_inv_i = @phi_geod_inv_i;
